...
from classifier_CRNN import config
...
img_dir = 'classifier_CRNN/data/VIB_page1'
config_file = 'classifier_CRNN/form/template_VIB_page1.txt'
img_path = 'classifier_CRNN/data/VIB_test_for_demo_06Mar/20200304 AICR Test-5.jpg'
img_path = 'classifier_CRNN/data/VIB_page1/vib_page1-22.jpg'
...
def predict(list_img_path, batch_size=16, post_processing=True,
            address_db_path='classifier_CRNN/symspellpy/db.pickle',
            address_csv_path='classifier_CRNN/symspellpy/dvhcvn.csv',
            country_db_path='classifier_CRNN/symspellpy/country-list.txt',
            name_dict="classifier_CRNN/symspellpy/freq_name_dic.txt",
            name_bigram="classifier_CRNN/symspellpy/freq_name_bigram.txt"):
