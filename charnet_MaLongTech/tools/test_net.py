...
def vis(img, word_instances, image_id, save_root):
    ...
    file_path='{}/{}.jpg'.format(save_root, image_id)
    print('Write result:',file_path)
    cv2.imwrite(file_path,img_word_ins)
    return img_word_ins
...
if __name__ == '__main__':
    ...
    for im_name in sorted(os.listdir(image_dir)):
        ...
        with torch.no_grad():
            ...
            vis(im_original, word_instances, os.path.splitext(im_name)[0], results_dir)
