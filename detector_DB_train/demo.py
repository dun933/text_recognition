...
# exp = 'config/td500_resnet50_deform_thre.yaml'
# img_path = '/data/data_invoices_preprocessed/96_2_c.jpg'
# detector_model = 'model_epoch_200_minibatch_297000_8Mar'
# detector_model = 'td500_resnet50'
# ckpt_path = '/home/ntanh/anhnt/aicr.core/detector_DB/pretrained/' + detector_model
...
# detector_model = 'model_epoch_1142_minibatch_24000'
# ckpt_path = '/home/aicr/cuongnd/aicr.core/detector_DB_train/workspace/outputs/train_2020-04-28_19-11/model/'+ detector_model
...
class Demo:
    ...
    def inference2(self, image_path, visualize=False):
        batch = dict()
        batch['filename'] = [image_path]
        img, original_shape = self.load_image(image_path)
        batch['shape'] = [original_shape]
