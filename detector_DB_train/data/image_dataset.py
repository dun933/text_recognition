    ...
    def get_all_samples(self):
        for i in range(len(self.data_dir)):
            ...
            if self.is_training:
                ...
                #t_path=[self.data_dir[i]+'/train_gts/'+timg.strip()+'.txt' for timg in image_list]
                #gt_path=[self.data_dir[i]+'/train_gts/'+timg.strip().replace('.png','.gt') for timg in image_list]
            else:
