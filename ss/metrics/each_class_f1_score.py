...
pred_dir = '/data/CuongND/aicr_vn/outputs/predict_2stages_2019-12-26_11-26'
...
tf = evaluator.GetTruePositive(allBoundingBoxes)  # Object containing all bounding boxes (ground truths and detections)
...
print('class vn: ' + str(TP_gt_vn / (TP_gt_vn + FN_gt_vn)) + ' TP: ' + str(TP_gt_vn) + ' FP: ' + str(FN_gt_vn))
print('class alp: ' + str(TP_gt_alp / (TP_gt_alp + FN_gt_alp)) + ' TP: ' + str(TP_gt_alp) + ' FP: ' + str(FN_gt_alp))
print('class sym: ' + str(TP_gt_sym / (TP_gt_sym + FN_gt_sym)) + ' TP: ' + str(TP_gt_sym) + ' FP: ' + str(FN_gt_sym))
print('class num: ' + str(TP_gt_num / (TP_gt_num + FN_gt_num)) + ' TP: ' + str(TP_gt_num) + ' FP: ' + str(FN_gt_num))
print('Total TP: ', TP_gt_vn + TP_gt_alp + TP_gt_sym + TP_gt_num)
print('Total FN: ', FN_gt_vn + FN_gt_alp + FN_gt_sym + FN_gt_num)
