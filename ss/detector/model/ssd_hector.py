...
def _block_inception_b(input):  # 512,  20
    ...
    branch_2 = _conv_block_bn(branch_1, 224, (5, 1))  # 224,  20
    branch_2 = _conv_block_bn(branch_1, 256, (1, 5))  # 256,  20
...
def SSD_AICR_v01(input_shape, num_classes=21):  # inception v4 style with Seperable Convolutions
    ...
    tem_i = 0
    while tem_i < 2:
        net = _block_inception_c(conv3)  # 1536,  10
        net = squeeze_excite_block(net)
        tem_i = tem_i + 1
    ...
    priorbox = PriorBox(img_size, 8.0, max_size=11.0, aspect_ratios=[0.33], variances=[0.1, 0.1, 0.2, 0.2],
    ...
    priorbox = PriorBox(img_size, 16.0, max_size=22.0, aspect_ratios=[0.33], variances=[0.1, 0.1, 0.2, 0.2],
    ...
    priorbox = PriorBox(img_size, 30.0, max_size=45.0, aspect_ratios=[0.33], variances=[0.1, 0.1, 0.2, 0.2],
    ...
    priorbox = PriorBox(img_size, 60.0, max_size=95.0, aspect_ratios=[0.33],
...
"""
aspect ratio 1에 대한 scale factor 조절
8, 16 
16, 30
30, 60
60, 130
...
def SSD_AICR_v02(input_shape, num_classes=21):  # inception v4 style with Seperable Convolutions
    if K.image_data_format() == 'channels_first':
        channel_axis = 1
    else:
        channel_axis = -1
    ...
    # upsampling Block
    net = _conv_block_up(conv4, 128, (3, 3), strides=(2, 2), padding='same')  # 256, 10
    conv3 = _conv_block_bn(conv3, 128, (3, 3), separble=False)  # 256,  5
    conv3 = Normalize(20, name='conv_up_2_0_normalize')(conv3)
    net = Normalize(10, name='conv_up_2_1_normalize')(net)
    conv3 = Add()([net, conv3])
    conv3 = BatchNormalization(axis=channel_axis)(conv3)

    net = _conv_block_up(conv3, 128, (3, 3), strides=(2, 2), padding='same')  # 256, 20
    conv2 = _conv_block_bn(conv2, 128, (3, 3), separble=False)  # 256,  5
    conv2 = Normalize(20, name='conv_up_3_0_normalize')(conv2)
    net = Normalize(10, name='conv_up_3_1_normalize')(net)
    conv2 = Add()([net, conv2])
    conv2 = BatchNormalization(axis=channel_axis)(conv2)

    net = _conv_block_up(conv2, 128, (3, 3), strides=(2, 2), padding='same')  # 256, 40
    conv1 = _conv_block_bn(conv1, 128, (3, 3), separble=False)  # 256,  5
    conv1 = Normalize(20, name='conv_up_4_0_normalize')(conv1)
    net = Normalize(10, name='conv_up_4_1_normalize')(net)
    conv1 = Add()([net, conv1])
    conv1 = BatchNormalization(axis=channel_axis)(conv1)

    net = _conv_block_up(conv1, 128, (3, 3), strides=(2, 2), padding='same')  # 64, 80
    conv0 = _conv_block_bn(conv0, 128, (3, 3), separble=False)  # 256,  5
    conv0 = Normalize(20, name='conv_up_5_0_normalize')(conv0)
    net = Normalize(10, name='conv_up_5_1_normalize')(net)
    conv0 = Add()([net, conv0])
    conv0 = BatchNormalization(axis=channel_axis)(conv0)
...
def SSD_AICR_v03(input_shape, num_classes=21):  # inception v4 style with Seperable Convolutions
    if K.image_data_format() == 'channels_first':
        channel_axis = 1
    else:
        channel_axis = -1
    ...
    net = _conv_block_up(conv4, 64, (3, 3), strides=(2, 2), padding='same')  # 256, 10
    conv3 = _conv_block_bn(conv3, 64, (3, 3), separble=False)  # 256,  5
    conv3 = Normalize(5, name='conv_up_2_0_normalize')(conv3)
    net = Normalize(5, name='conv_up_2_1_normalize')(net)
    conv3 = Add()([net, conv3])
    conv3 = BatchNormalization(axis=channel_axis)(conv3)

    net = _conv_block_up(conv3, 64, (3, 3), strides=(2, 2), padding='same')  # 256, 20
    conv2 = _conv_block_bn(conv2, 64, (3, 3), separble=False)  # 256,  5
    conv2 = Normalize(5, name='conv_up_3_0_normalize')(conv2)
    net = Normalize(5, name='conv_up_3_1_normalize')(net)
    conv2 = Add()([net, conv2])
    conv2 = BatchNormalization(axis=channel_axis)(conv2)

    net = _conv_block_up(conv2, 64, (3, 3), strides=(2, 2), padding='same')  # 256, 40
    conv1 = _conv_block_bn(conv1, 64, (3, 3), separble=False)  # 256,  5
    conv1 = Normalize(5, name='conv_up_4_0_normalize')(conv1)
    net = Normalize(5, name='conv_up_4_1_normalize')(net)
    conv1 = Add()([net, conv1])
    conv1 = BatchNormalization(axis=channel_axis)(conv1)

    net = _conv_block_up(conv1, 64, (3, 3), strides=(2, 2), padding='same')  # 64, 80
    conv0 = _conv_block_bn(conv0, 64, (3, 3), separble=False)  # 256,  5
    conv0 = Normalize(5, name='conv_up_5_0_normalize')(conv0)
    net = Normalize(5, name='conv_up_5_1_normalize')(net)
    conv0 = Add()([net, conv0])
    conv0 = BatchNormalization(axis=channel_axis)(conv0)
...
def SSD_AICR_v04(input_shape, num_classes=21):  # inception v4 style with Seperable Convolutions
    # if K.image_data_format() == 'channels_first':
    #     channel_axis = 1
    # else:
    #     channel_axis = -1
...
if __name__ == '__main__':
    ...
    model = SSD_AICR_v03(input_shape, NUM_CLASSES)
    model.summary()
    from keras.utils import plot_model
    plot_model(model, show_shapes=True, to_file='SSD_AICR_v03.png')