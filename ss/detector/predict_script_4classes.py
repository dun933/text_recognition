...
from utils.run_util import drawAnnotation, calculateIOU, calculateIOU2, showTableDocument, showLineUpDocument, showTableDocument2, showLineUpDocument2
from utils.image_processing_util import zoomScaleFinder, skew_detect, skew_detect2
...
nms_thres = 0.45
max_size = 2000
result_save_dir = 'outputs/predict_'+training_time
...
img_dir = 'data/test_image_vn/image'
#img_dir = 'data'
file_list = [
    '20190731_144554',
    '20190731_144540',
...
GT_dir =  'data/test_image_vn/v2/ground_truth'
...
def predict(get_map=True):
    ...
    for file_name in file_list:
        ...
        result_save_path = os.path.join(result_save_dir,
                                        file_name + '_annotation_nms_thresh_{}_{}.jpg'.format(iou_threshold, NMS_ALGORITHM))
        ...
        for line in fh1:
            ...
            if isGT:
                if splitLine[0] != '':
                    ...
                    # if (classID == 'number' or classID == 'alphabet'):
                    #     classID = "vietnam"
                    classID = "vietnam"
                ...
                if splitLine[0] != '':
                    ...
                    # if classID == 'vietnam' or classID == 'alphabet' or classID == 'number':
                    #     classID = "vietnam"
                    classID = "vietnam"
                    bb = BoundingBox(
                        nameOfImage,
