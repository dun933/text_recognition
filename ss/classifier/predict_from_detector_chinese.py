...
result_detector_dir = '/data/data_thang/detection_outputs/predict_2019-11-16_15-22/'
#result_detector_dir = '/data/data_thang/detection_outputs/predict_2019-11-13_12-06/'
...
output_dir = '/data/data_thang/classification_outputs/predict_from_detector_' + training_time
...
def pred_from_detector(conf_thres_detector=thres_detector, conf_thres_classifier=thres_classifier):
