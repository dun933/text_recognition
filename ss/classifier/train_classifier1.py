...
save_dir= configmanager.save_classifier1_dir+ '/train_classifier1_'+training_time
os.environ["CUDA_DEVICE_ORDER"] = "PCI_BUS_ID"
os.environ["CUDA_VISIBLE_DEVICES"] = str(configmanager.gpu_num_classifier1_train)
...
# data load
train_data_path = configmanager.train_classifier1_dir
val_data_path = configmanager.val_classifier1_dir
train_batch_size = configmanager.batch_size_classifier1
val_batch_size = configmanager.batch_size_classifier1
...
inputs = Input(shape=configmanager.input_size_classifier1)
